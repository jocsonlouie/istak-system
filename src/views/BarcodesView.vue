                ...
                <v-card flat class="">
                  <v-row row wrp>
                    <v-col cols="12" md="6">
                      <!-- Scan Barcode Modal -->
                      <v-card
                        class="pa-5 d-flex flex-column justify-start"
                        height="340"
                        width="450"
                      >
                        <v-card-title
                          class="-d-flex justify-start pa-0 my-3 overflow-hidden"
                        >
                          <StreamBarcodeReader
                            max-width="250"
                            @decode="onDecode"
                      ...
                      <v-card flat class="px-3">
                        <v-row no-gutters class="d-flex justify-center">
                          <v-col cols="12" sm="3" class="ma-2">
                            <v-text-field
                              label="Total Stocks (including on display)"
                              value="43"
                              outlined
                              dense
                              readonly
                          ...
                          <v-col cols="12" sm="3" class="ma-2">
                            <v-text-field
                              label="Low Stock Quantity Indicator"
                              value="5"
                              outlined
                              dense
                              readonly
              ...
              <v-container class="my-5">
                <v-card flat class="">
                  <v-row row wrp>
                    ...
                    <v-col xs="2">
                      <p
                        class="fled-x justify-center font-weight-black text-h7"
                      >
                        Are you sure you want to DELETE 'NOBIVAC DHPPI L4' ITEM?
                      </p>
                      <!-- upload photo -->
                      <v-card-text class="mt-10">

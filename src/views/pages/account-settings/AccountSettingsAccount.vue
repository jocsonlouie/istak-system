    ...
    <v-card-text>
      <v-form class="multi-col-validation mt-6">
        <v-row>
          ...
          <v-col md="6" cols="12">
            <v-text-field v-model="userFName" label="Name" dense outlined></v-text-field>
          </v-col>

          <v-col cols="12" md="6">
            <v-text-field v-model="userEmail" label="E-mail" dense outlined :disabled="userVerified"></v-text-field>
          </v-col>


          <v-col cols="12" md="6">
            <v-select v-model="userRole" dense outlined label="Role" :items="status"></v-select>
          </v-col>
          ...
          <v-col cols="12">
            <v-dialog v-model="dialog" persistent max-width="350">
              <template v-slot:activator="{ on, attrs }">
                ...
                <v-btn color="primary" class="me-3 mt-4" v-bind="attrs" v-on="on">
                  Save changes
                </v-btn>
              </template>
              <v-card>
                ...
                <v-card-text>Changes have been made to this account. <br>Do you want to save these changes?
                </v-card-text>
                <v-card-actions>
                  <v-spacer></v-spacer>
                  ...
                  <v-btn color="primary" class="me-3" @click="updateAccountDetails">
                    Save
                  </v-btn>
                </v-card-actions>
              </v-card>
...
import { mdiAlertOutline, mdiCloudUploadOutline, mdiCheckCircle, mdiProgressDownload } from '@mdi/js';
...
const userFName = ref('');
const userEmail = ref('');
const userAvatar = ref('https://assumptaclinic.com/wp-content/uploads/2022/10/default-assumpta.jpg');
...
export default {
  ...
  setup(props) {
    const status = ['Inventory Admin', 'Inventory Staff', 'Non-Inventory Staff', "Can't Access"]
